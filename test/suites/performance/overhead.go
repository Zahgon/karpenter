...
func MemoryOverheadMB() float64 { _ = "STUB: not implemented"; return 0 }
...
func CPUOverheadNanos() float64 { _ = "STUB: not implemented"; return 0 }

func envFloat64(key string, defaultVal float64) float64 { _ = "STUB: not implemented"; return 0 }
