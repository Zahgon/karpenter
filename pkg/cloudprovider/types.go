...
//
//nolint:gocyclo
func (in *InstanceType) DeepCopyInto(out *InstanceType) { _ = "STUB: not implemented"; return }
...
func (i *InstanceType) precompute() { _ = "STUB: not implemented"; return }
...
func (i *InstanceType) IsPricingOverlayApplied() bool { _ = "STUB: not implemented"; return false }
...
func (i *InstanceType) IsCapacityOverlayApplied() bool { _ = "STUB: not implemented"; return false }
...
func (o *Offering) ApplyPriceOverlay(UpdatedPrice string) { _ = "STUB: not implemented"; return }
...
func (o *Offering) IsPriceOverlaid() bool { _ = "STUB: not implemented"; return false }

func (o *Offering) CapacityType() string { _ = "STUB: not implemented"; return "" }

func (o *Offering) Zone() string { _ = "STUB: not implemented"; return "" }

func (o *Offering) ReservationID() string { _ = "STUB: not implemented"; return "" }

// +k8s:deepcopy-gen=true
type Offerings []*Offering

// Available filters the available offerings from the returned offerings
func (ofs Offerings) Available() Offerings { _ = "STUB: not implemented"; return *new(Offerings) }
...
func (ofs Offerings) Cheapest() *Offering { _ = "STUB: not implemented"; return nil }

// MostExpensive returns the most expensive offering from the return offerings
func (ofs Offerings) MostExpensive() *Offering { _ = "STUB: not implemented"; return nil }
...
func (e *NodeClaimNotFoundError) Error() string { _ = "STUB: not implemented"; return "" }

func (e *NodeClaimNotFoundError) Unwrap() error { _ = "STUB: not implemented"; return nil }
...
func (e *InsufficientCapacityError) Error() string { _ = "STUB: not implemented"; return "" }

func (e *InsufficientCapacityError) Unwrap() error { _ = "STUB: not implemented"; return nil }

func IsInsufficientCapacityError(err error) bool { _ = "STUB: not implemented"; return false }
...
func (e *NodeClassNotReadyError) Error() string { _ = "STUB: not implemented"; return "" }

func (e *NodeClassNotReadyError) Unwrap() error { _ = "STUB: not implemented"; return nil }

func IsNodeClassNotReadyError(err error) bool { _ = "STUB: not implemented"; return false }
...
func (e *CreateError) Error() string { _ = "STUB: not implemented"; return "" }
...
func (e *UnevaluatedNodePoolError) Error() string { _ = "STUB: not implemented"; return "" }

func IsUnevaluatedNodePoolError(err error) bool { _ = "STUB: not implemented"; return false }
...
func (id DeviceID) String() string { _ = "STUB: not implemented"; return "" }
