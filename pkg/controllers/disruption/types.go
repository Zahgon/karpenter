...
func (c *Candidate) OwnedByStaticNodePool() bool { _ = "STUB: not implemented"; return false }
...
func (c Command) Decision() Decision { _ = "STUB: not implemented"; return *new(Decision) }

// SourceNodeNames returns the names of all candidate nodes
func (c Command) SourceNodeNames() []string { _ = "STUB: not implemented"; return nil }

// String returns a human-readable representation of the command
func (c Command) String() string { _ = "STUB: not implemented"; return "" }
...
func (c Command) StringForNode(candidate *Candidate) string { _ = "STUB: not implemented"; return "" }
...
func (c Command) EstimatedSavings() float64 { _ = "STUB: not implemented"; return 0 }
...
func (c Command) EmitCandidateEvents(recorder events.Recorder) { _ = "STUB: not implemented"; return }
...
func (c Command) LogValues() []any { _ = "STUB: not implemented"; return nil }
